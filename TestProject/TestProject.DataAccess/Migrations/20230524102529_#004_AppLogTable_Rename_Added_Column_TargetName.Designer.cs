...
namespace TestProject.Migrations
{
    ...
    [Migration("20230524102529_#004_AppLogTable_Rename_Added_Column_TargetName")]
    partial class _004_AppLogTable_Rename_Added_Column_TargetName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestProject.Models.AlphabeticalListOfProduct", b =>
                {
            ...
            modelBuilder.Entity("TestProject.Models.CategorySalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("TestProject.Models.CurrentProductList", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TestProject.Models.CustomerAndSuppliersByCity", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("TestProject.Models.CustomerDemographic", b =>
                {
                    b.Property<string>("CustomerTypeId")
                        .HasMaxLength(10)
                        .HasColumnType("nchar(10)")
            ...
            modelBuilder.Entity("TestProject.Models.Invoice", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("TestProject.Models.OrderDetailsExtended", b =>
                {
                    b.Property<float>("Discount")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("TestProject.Models.OrderSubtotal", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("TestProject.Models.OrdersQry", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("TestProject.Models.ProductSalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("TestProject.Models.ProductsAboveAveragePrice", b =>
                {
                    b.Property<string>("ProductName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("TestProject.Models.ProductsByCategory", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("TestProject.Models.QuarterlyOrder", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("TestProject.Models.Region", b =>
                {
            ...
            modelBuilder.Entity("TestProject.Models.SalesByCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasColumnName("CategoryID");
            ...
            modelBuilder.Entity("TestProject.Models.SalesTotalsByAmount", b =>
                {
                    b.Property<string>("CompanyName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("TestProject.Models.Shipper", b =>
                {
            ...
            modelBuilder.Entity("TestProject.Models.SummaryOfSalesByQuarter", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("TestProject.Models.SummaryOfSalesByYear", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("TestProject.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TestProject.Models.Territory", b =>
                {
                    b.Property<string>("TerritoryId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("CustomerCustomerDemo", b =>
                {
                    b.HasOne("TestProject.Models.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerDemo_Customers");

                    b.HasOne("TestProject.Models.CustomerDemographic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    ...
                    b.HasOne("TestProject.Models.Territory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TestProject.Models.Employee", b =>
                {
                    b.HasOne("TestProject.Models.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("TestProject.Models.Order", b =>
                {
                    ...
                    b.HasOne("TestProject.Models.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("TestProject.Models.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("TestProject.Models.Product", b =>
                {
                    ...
                    b.HasOne("TestProject.Models.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("TestProject.Models.Territory", b =>
                {
                    b.HasOne("TestProject.Models.Region", "Region")
